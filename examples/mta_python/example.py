...
# closest stop is 0, furthest stop is N
SOUTH_BOUND_STOPS = ["G26S", "G24S", "G22S"]
NORTH_BOUND_STOPS = ["G29N", "G30N", "G31N", "G32N", "G33N", "G34N", "G35N", "G36N", "A42N",
                     "F20N", "F21N", "F22N", "F23N", "F24N", "F25N", "F26N", "F27N"]
# distance to next stop (directional)
SOUTH_BOUND_STOP_DISTANCE = [.47, 1.17, .27]
NORTH_BOUND_STOP_DISTANCE = [.73, .56, .39, .30, .51, .37, .37, .37, .56,
                             .45, .45, .41, .49, .43, .60, .81, .51]
